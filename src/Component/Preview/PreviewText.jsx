...
import ViewOnlyTextEditor from "../../CommonComponents/TextEditor/ViewOnlyTextEditorNoAnimation.jsx";
...
const PreviewText = ({ DataCheck, style, ...props }) => {
  return (
    <TextElement item={DataCheck?.style || style} {...props}>
      {DataCheck?.data ? (
        <ViewOnlyTextEditor 
          data={DataCheck.data} 
          style={DataCheck?.style || style}
        />
      ) : (
